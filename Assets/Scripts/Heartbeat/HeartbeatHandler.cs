...
public class HeartbeatHandler : MonoBehaviour
{
    ...
    void Start()
    {
        leftGloveHandler = GameObject.Find("Generic Hand_Left").GetComponent<HaptGloveHandler>();
        rightGloveHandler = GameObject.Find("Generic Hand_Right").GetComponent<HaptGloveHandler>();
